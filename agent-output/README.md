...
This directory contains all non-Bicep artifacts generated by the Agentic Workflow.
...
│   ├── 07-documentation-index.md        # Step 7: Documentation master index (optional)
│   ├── 07-design-document.md            # Step 7: Comprehensive design document (optional)
│   ├── 07-operations-runbook.md         # Step 7: Operational procedures (optional)
│   ├── 07-resource-inventory.md         # Step 7: Resource inventory from IaC (optional)
│   ├── 07-compliance-matrix.md          # Step 7: Security controls mapping (optional)
│   └── 07-backup-dr-plan.md             # Step 7: Backup and DR procedures (optional)
└── README.md                            # This file
```
...
| 7    | `07-`  | `documentation-index.md`, `design-document.md`, `operations-runbook.md`, etc. |

> **Note**: Step 1 (@plan) outputs remain in chat context. Step 5 Bicep code lives in `infra/bicep/{project}/`.
> Step 7 (workload-documentation-generator) is optional - invoke when customer-deliverable docs are needed.
